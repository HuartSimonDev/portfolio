function MainPage() {
    ...
    return (
        <div className="p-10">
            ...
            <h1 className="mt-20">Contactez-moi</h1>

            <div className="mt-5 flex flex-row gap-3">
                <a
                    href="mailto:huartsimon0709@gmail.com"
                    target="_blank"
                    className="bg-color-bg2-light hover:bg-color-bg3-light dark:bg-color-bg2-dark dark:hover:bg-color-bg3-dark p-3 border-1 rounded-lg flex basis-1/3 justify-start items-center gap-3"
                >
                    {/* bootstrap icon */}
                    <svg
                ...
                <a
                    href="https://www.linkedin.com/in/huart-simon/"
                    target="_blank"
                    className="bg-color-bg2-light hover:bg-color-bg3-light dark:bg-color-bg2-dark dark:hover:bg-color-bg3-dark p-3 border-1 rounded-lg flex basis-1/3 justify-start items-center gap-3"
                >
                    {/* bootstrap icon */}
                ...
                <a
                    href="https://github.com/HuartSimonDev"
                    target="_blank"
                    className="bg-color-bg2-light hover:bg-color-bg3-light dark:bg-color-bg2-dark dark:hover:bg-color-bg3-dark p-3 border-1 rounded-lg flex basis-1/3 justify-start items-center gap-3"
                >
                    {/* bootstrap icon */}
